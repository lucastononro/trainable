...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_dataset_versions_hash'), 'dataset_versions', ['hash'], unique=False)
    op.create_index(op.f('ix_dataset_versions_kind'), 'dataset_versions', ['kind'], unique=False)
    op.create_index(op.f('ix_dataset_versions_parent_id'), 'dataset_versions', ['parent_id'], unique=False)
    op.create_index(op.f('ix_dataset_versions_project_id'), 'dataset_versions', ['project_id'], unique=False)
    op.create_index(op.f('ix_dataset_versions_source_experiment_id'), 'dataset_versions', ['source_experiment_id'], unique=False)
    op.create_index(op.f('ix_dataset_versions_source_session_id'), 'dataset_versions', ['source_session_id'], unique=False)
    ...
    op.create_index(op.f('ix_registered_models_experiment_id'), 'registered_models', ['experiment_id'], unique=False)
    op.create_index(op.f('ix_registered_models_project_id'), 'registered_models', ['project_id'], unique=False)
    op.create_index(op.f('ix_registered_models_source_session_id'), 'registered_models', ['source_session_id'], unique=False)
    ...
    op.create_table('experiment_datasets',
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    ...
    op.create_index(op.f('ix_experiment_datasets_dataset_version_id'), 'experiment_datasets', ['dataset_version_id'], unique=False)
    op.create_index(op.f('ix_experiment_datasets_experiment_id'), 'experiment_datasets', ['experiment_id'], unique=False)
    ...
    op.create_index(op.f('ix_log_events_session_id'), 'log_events', ['session_id'], unique=False)
    ...
    op.create_table('processed_dataset_meta',
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('session_id', sa.String(length=36), nullable=False),
    sa.Column('experiment_id', sa.String(length=36), nullable=False),
    ...
    op.create_index(op.f('ix_processed_dataset_meta_experiment_id'), 'processed_dataset_meta', ['experiment_id'], unique=False)
    op.create_index(op.f('ix_processed_dataset_meta_session_id'), 'processed_dataset_meta', ['session_id'], unique=False)
    op.create_table('run_snapshots',
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('experiment_id', sa.String(length=36), nullable=True),
    sa.Column('session_id', sa.String(length=36), nullable=True),
    ...
    op.create_index(op.f('ix_run_snapshots_experiment_id'), 'run_snapshots', ['experiment_id'], unique=False)
    op.create_index(op.f('ix_run_snapshots_session_id'), 'run_snapshots', ['session_id'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_processed_dataset_meta_session_id'), table_name='processed_dataset_meta')
    op.drop_index(op.f('ix_processed_dataset_meta_experiment_id'), table_name='processed_dataset_meta')
    ...
    op.drop_index(op.f('ix_experiment_datasets_experiment_id'), table_name='experiment_datasets')
    op.drop_index(op.f('ix_experiment_datasets_dataset_version_id'), table_name='experiment_datasets')
    ...
    op.drop_index(op.f('ix_registered_models_source_session_id'), table_name='registered_models')
    op.drop_index(op.f('ix_registered_models_project_id'), table_name='registered_models')
    op.drop_index(op.f('ix_registered_models_experiment_id'), table_name='registered_models')
    op.drop_table('registered_models')
    op.drop_index(op.f('ix_dataset_versions_source_session_id'), table_name='dataset_versions')
    op.drop_index(op.f('ix_dataset_versions_source_experiment_id'), table_name='dataset_versions')
