        ...
        **kwargs,
        ...
        try:
            ...
            cfg = genai_types.GenerateContentConfig(
                ...
                tools=[genai_types.Tool(function_declarations=fn_decls)] if fn_decls else None,
            )
            ...
            for cand in resp.candidates or []:
                for part in (cand.content.parts if cand.content else []):
                    ...
                    if fn_call:
                        try:
                            args = json.loads(fn_call.args) if isinstance(fn_call.args, str) else dict(fn_call.args or {})
