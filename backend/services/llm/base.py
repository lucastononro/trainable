...
class LLMEvent:
    ...
    @classmethod
    def tool_call(cls, *, tool_name: str, tool_call_id: str, arguments: dict) -> "LLMEvent":
    ...
    @classmethod
    def tool_result(cls, *, tool_call_id: str, content: Any, is_error: bool = False) -> "LLMEvent":
    ...
    @classmethod
    def usage(cls, *, model: str, usage: dict, total_cost_usd: float | None = None) -> "LLMEvent":
        return cls("usage", {
            "model": model,
            "usage": usage,
